...
- 앱: 국어교과 문항 출제기
- 주소: https://ais-dev-bad33uy66kjf2supkpa2bw-961439429570.asia-east1.run.app 
- 스택: Vite
...
- [v] HTTPS 강제(HTTP→HTTPS 리다이렉트) — HTTP 요청이 HTTPS로 리다이렉트됨 (HTTP 302 -> https://ais-dev-bad33uy66kjf2supkpa2bw-961439429570.asia-east1.run.app/)
